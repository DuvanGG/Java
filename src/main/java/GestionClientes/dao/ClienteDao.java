...
/**
 * El objetivo de esta clase es recibir objetos de la 
 * clase cliente y guardarla en la base de datos, ademas
 * de leer y transformar los datos a objetos cliente.
 * @author duvan
 */
